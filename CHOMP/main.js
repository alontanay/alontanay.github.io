...
function mousemove(e) {
    mousePos.x = e.clientX - Math.floor(canvasRect.left) - 5, 
    mousePos.y = e.clientY - Math.floor(canvasRect.top) - 5;
    // screen.fillStyle = 'red';
    // screen.fillRect(mousePos.x-5,mousePos.y-5,10,10);
}
...
function mousedown() {
    ...
    if(clickedBlock == cols*rows-1) {
        ...
        fillBoard(lastMove);
        console.log('next move after:',getNextMove(board),encode(board),dp[encode(board)]);
